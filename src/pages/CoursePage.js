...
export default function CoursePage() {
  ...
  const [activeTab, setActiveTab] = useState('course'); // 'course', 'record', or 'community'
      ...
      <main className="p-8 max-w-6xl mx-auto">
          ...
          <div className="mb-8 flex gap-3">
            <button
              ...
              className={`px-6 py-3 rounded-lg font-medium text-base transition-colors shadow-sm ${
                activeTab === 'course'
          ...
          {activeTab === 'community' ? (
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-12 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Record</h2>
              <p className="text-gray-600">Course records and grades will be displayed here</p>
            </div>
          ) : (
            <>
